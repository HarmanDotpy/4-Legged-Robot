...
while(True):
    ...
    for t in range(50,99):
        ...
        leg2m1.write(-ang1[(t+50)%100])
        leg2m2.write(-180-ang2[(t+50)%100])
        leg3m1.write(ang1[(t+75)%100])
        leg3m2.write(180+ang2[(t+75)%100])
        leg4m1.write(-angs1[(t+25)%100])
        leg4m2.write(-180-angs2[(t+25)%100])
        time.sleep(0.02)
    ...
    for t in range(50,99):
        leg1m1.write(ang1[t])
        leg1m2.write(180+ang2[t])
        leg2m1.write(-angs1[(t+50)%100])
        leg2m2.write(-180-angs2[(t+50)%100])
        leg3m1.write(ang1[(t+75)%100])
        leg3m2.write(180+ang2[(t+75)%100])
        leg4m1.write(-ang1[(t+25)%100])
        leg4m2.write(-180-ang2[(t+25)%100])
